package com.lzanik.tutorialmod.block;

import com.lzanik.tutorialmod.TutorialMod;
import com.lzanik.tutorialmod.block.custom.FirestoneBlock;
import com.lzanik.tutorialmod.item.ModItemGroup;
import com.lzanik.tutorialmod.item.ModItems;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> AMETHYST_STAIRS = registerBlock("amethyst_stairs",
            () -> new StairsBlock(() -> AMETHYST_BLOCK.get().getDefaultState(),
                    AbstractBlock.Properties.create(Material.GLASS).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()));
    ...
    public static final RegistryObject<Block> AMETHYST_BUTTON = registerBlock("amethyst_button",
            () -> new StoneButtonBlock(AbstractBlock.Properties.create(Material.IRON).
                    harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(2f).doesNotBlockMovement()));
